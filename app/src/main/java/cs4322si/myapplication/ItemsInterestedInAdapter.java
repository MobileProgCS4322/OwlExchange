...
public class ItemsInterestedInAdapter extends RecyclerView.Adapter<ItemsInterestedInAdapter.OwlitemHolder> {
    ...
    public class OwlitemHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public OwlitemHolder(View itemView) {
            ...
            mPoster = itemView.findViewById(R.id.mPostedBy);
    ...
    public ItemsInterestedInAdapter(List<Owlitem> owlitemList) {
    ...
    public OwlitemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.itemsinterestedin_layout, parent, false);
