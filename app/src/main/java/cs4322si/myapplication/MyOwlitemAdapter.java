...
public class MyOwlitemAdapter extends RecyclerView.Adapter<MyOwlitemAdapter.OwlitemHolder> {
    ...
    public MyOwlitemAdapter(List<Owlitem> owlitemList) {
    ...
    public OwlitemHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.myitem4salelayout, parent, false);
